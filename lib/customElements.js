...
module.exports.notifyUpRooted = function(n) {
  if (!exports.preventNotify) {
    // when parsing nodes are appended into mock document
    // in this case their connecedCb is not called
    if (n.parentNode && n.parentNode.tagName === 'HTML' && n.ownerDocument.defaultView === undefined) {
      return;
    }
    // CEv1
